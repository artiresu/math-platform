...
export function PageShell({ children, mainClassName, noScroll }: PageShellProps) {
  ...
  return (
    <div className={rootClass}>
      ...
      <div
        className="pointer-events-none absolute -right-48 top-32 h-[550px] w-[550px] rounded-full bg-violet-400/[0.13] dark:bg-indigo-600/10 blur-[120px] dark:blur-[140px] animate-stagnant-drift-1"
        aria-hidden
      />
      <div
        className="pointer-events-none absolute -left-48 top-96 h-[500px] w-[500px] rounded-full bg-cyan-400/10 dark:bg-indigo-500/8 blur-[110px] dark:blur-[130px] animate-stagnant-drift-2"
        aria-hidden
      />
      <div
        className="pointer-events-none absolute -right-24 bottom-32 h-[450px] w-[450px] rounded-full bg-rose-400/[0.07] dark:bg-violet-600/8 blur-[110px] dark:blur-[130px] animate-stagnant-drift-3"
        aria-hidden
      />
