        ...
        notes: [
          {
            heading: "Polar form",
            paragraphs: [
              "Write z = re^{iθ} to turn multiplication into adding arguments and powers into scaling the modulus.",
        ...
        notes: [
          {
            ...
            paragraphs: [
              "Use vector equations r = a + λb for lines and scalar products to test orthogonality or find distances.",
        ...
        notes: [
          {
            ...
            paragraphs: [
              "Tilt your axes along and perpendicular to the plane. Gravity splits into g sin β down the slope and g cos β into the plane.",
            ],
            formulaTex:
        ...
        notes: [
          {
            heading: "Framework",
            paragraphs: [
              "State H₀ and H₁, choose a test statistic, and compare a p-value or critical value at a given significance level.",
            ],
          },
        ],
        practice: {
